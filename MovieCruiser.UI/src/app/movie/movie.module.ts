...
@NgModule({
  ...
  declarations: [ContainerComponent, ThumbnailComponent, SearchComponent, CommentdialogComponent, DetaildialogComponent],
  ...
  entryComponents:[CommentdialogComponent, DetaildialogComponent]
})
